...
class RabbitMQSettings(BaseSettings, case_sensitive=False):
    ...
    notification_queue_name: str = Field("test_notification_queue", max_length=200, min_length=5)
    registration_queue_name: str = Field("test_registration_queue", max_length=200, min_length=5)
