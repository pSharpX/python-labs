...
from app.application.ports.repositories import BookRepository, AuthorRepository, CategoryRepository
...
class CreateBookUseCase:
    ...
    def execute(self, request: CreateBookRequest) -> Book:
        ...
        new_book = Book(
            ...
            category=Category(id=category_existing.id, name=category_existing.name, description=category_existing.description),
